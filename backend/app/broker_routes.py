...
def _parse_tables(url, source, limit=100):
    ...
    for df in tables:
        ...
        for _,row in df.iterrows():
            ...
            if not re.search(r"buy|sell|hold|accumulate|reduce|add|outperform|underperform|neutral|overweight|equalweight",rating,re.I):continue
...
def register_broker_routes(app, nse_get):
    ...
    def collect():
        ...
        feeds=[
            ("Moneycontrol", "https://www.moneycontrol.com/broker-research/myStocksAll/?classic=true"),
            ("Moneycontrol Latest Research", "https://www.moneycontrol.com/broker-research/latestResearchReport/"),
        ...
        for source,url in feeds:
            for x in _parse_tables(url,source,100):
